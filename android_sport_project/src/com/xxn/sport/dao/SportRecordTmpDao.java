...
/** 
 * DAO for table "SPORT_RECORD_TMP".
*/
public class SportRecordTmpDao extends AbstractDao<SportRecordTmp, Void> {

    public static final String TABLENAME = "SPORT_RECORD_TMP";

    /**
     * Properties of entity SportRecordTmp.<br/>
    ...
    */
    ...
    public SportRecordTmpDao(DaoConfig config) {
        super(config);
    }
    
    public SportRecordTmpDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SPORT_RECORD_TMP\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SPORT_RECORD_TMP\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, SportRecordTmp entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public SportRecordTmp readEntity(Cursor cursor, int offset) {
        SportRecordTmp entity = new SportRecordTmp( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, SportRecordTmp entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(SportRecordTmp entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(SportRecordTmp entity) {
        return null;
    }
