...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        IntegralGainedDao.createTable(db, ifNotExists);
        SportRecordDao.createTable(db, ifNotExists);
        SportRecordTmpDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        IntegralGainedDao.dropTable(db, ifExists);
        SportRecordDao.dropTable(db, ifExists);
        SportRecordTmpDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(IntegralGainedDao.class);
        registerDaoClass(SportRecordDao.class);
        registerDaoClass(SportRecordTmpDao.class);
    }
